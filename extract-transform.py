...
genres_df = genres_df["genre_id"].astype(dtype="Int64")

#print(now_playing_df_exploded.head())
#print(genres_df.dtypes)

now_playing_df_merged = pd.merge(left=now_playing_df_exploded, right=genres_df, left_on="genre", right_on="genre_id")
print(now_playing_df_merged.head())
